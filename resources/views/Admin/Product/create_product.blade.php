            ...
            <div class="row">
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select" name="product_title" required>
                                        <option value="">Choice Title</option>
                                        @if(!empty($productTitles))
                                            @foreach ($productTitles as $productTitle)
                                                <option value="{{ $productTitle->product_title }}">{{ $productTitle->product_title }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-3 col-md-3 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="product_width" placeholder="Width" required>
                                </div>
                            </div>
                            <div class="col-sm-3 col-md-3 col-lg-3">
                                <div class="form-group">
                                    <label>Height<span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="product_height" placeholder="Height" required>
                                </div>
                            </div>
                        </div>
                        <div class="m-t-20 ">
